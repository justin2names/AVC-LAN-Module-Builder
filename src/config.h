...
// TX LED connected to Pin5  of  PORTD // changed from Pin0  of  PORTC
...
#define AVC_BIT_0_HOLD_ON_MIN_LENGTH		0x1E  // 30 uS * (F_CPU / 1000000L / 8)    Compare half way between a '1' (20 us) and a '0' (32 us ): 32 - (32 - 20) /2 = 26 us
